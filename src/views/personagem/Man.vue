...
export default {
  ...
  computed: {
    man() {
      const man = this.personagens.filter(function (obj) {
        return obj.sexo === "Masculino";
      });
      return man;
    },
  },
  methods: {
    exibirLocalStorage() {
      let personagensStorage = JSON.parse(localStorage.getItem("dados"));
      this.personagens = this.personagens.concat(personagensStorage);
    },
  },
  beforeMount() {
